...
unsigned char* AES::EncryptECB(const unsigned char in[], const unsigned int inLen, const unsigned char key[], unsigned int& outLen)
{
...
unsigned char* AES::EncryptCBC(const unsigned char in[], unsigned int inLen, const unsigned char key[], const unsigned char* iv, unsigned int& outLen)
{
    outLen = GetPaddingLength(inLen);
    unsigned char* alignIn = PaddingNulls(in, inLen, outLen);
    unsigned char* out = new unsigned char[outLen];
...
unsigned char* AES::EncryptCFB(const unsigned char in[], unsigned int inLen, const unsigned char key[], const unsigned char* iv, unsigned int& outLen)
{
    outLen = GetPaddingLength(inLen);
    unsigned char* alignIn = PaddingNulls(in, inLen, outLen);
    unsigned char* out = new unsigned char[outLen];
